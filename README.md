...
[![Services](https://img.shields.io/badge/Services-40%20built%20%2F%2041-brightgreen)](#-the-catalogue)
...
**Self-hosted services, deployed properly.** One script installs the Docker foundation; a menu deploys any of **40 services** on top of it — each with a reverse proxy route, a backup path, and documentation written from actually running it.
...
| 🧩 [**Multi-Agent**](services/Multi-Agent/) | **Paperclip** · **Dify** · **Flowise** · Langflow | 3/4 |
...
**40 of 41 services are built.** The remaining two are in [Multi-Agent](services/Multi-Agent/) — Langflow, and Flowise pending its first live run.
