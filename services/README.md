...
[`services.sh`](services.sh) presents these grouped by category. **Everything listed below is built and deployable** — that is why nothing carries a status marker: a tick on all 41 rows tells you nothing that this sentence does not.
